...
char* Concert::nextTime(int w[],char c,int sf,char*date)
{
    ...
    {
        return "Nu exista data programata pentru concert in viitorul anului 2023.\n";
    }
    else
    {
        cout<<"Urmatorul concert din anul 2023 va fi in data de: ";
        return mini;
    }
}
...
ostream& operator <<(ostream& out, const Concert& obj)
{
    ...
    out << "Data concertului din anul 2023: " << obj.data<<" la ora: "<< obj.ora<< endl;
...
istream& operator >>(istream& in, Concert& obj)
{
    ...
    cout << "Introduceti data concertului din anul 2023: " << endl;
    char data[6];
    in >> data;
    if(obj.data != NULL)
    {
...
int main()
{
    ...
    if(alegere0)
    {
        ...
        Concert k2('M', "16:00", "03.05", "Dvořák Cello Concerto in B minor, Op. 104");
    ...
    cout<<"Suma totala a biletelor este: "<<pret<<" lei.\n";

    cout<<"Va multumesc pentru atentia acordata, multa sanatate!";
